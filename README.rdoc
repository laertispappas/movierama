...
* Configuration
    - EMAIL (smtp on production (config/environments/production), mailcatcher on development)
    - set host your on: config.action_mailer.default_url_options = { host: 'yourhost.com' }
